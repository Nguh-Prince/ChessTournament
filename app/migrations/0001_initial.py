    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('m', 'Male'), ('f', 'Female'), ('nb', 'Non binary'), ('rns', 'Rather not say')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fixture', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.fixture')),
            ],
        ),
        migrations.CreateModel(
            name='PlayerFixture',
